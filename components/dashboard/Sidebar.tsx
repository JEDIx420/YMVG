      ...
      <AnimatePresence>
        {(isOpen || typeof window !== 'undefined' && window.innerWidth >= 768) && (
          <motion.aside
            ...
            className={`fixed md:sticky top-0 left-0 z-50 w-72 h-screen bg-slate-50 border-r border-slate-200/80 flex flex-col justify-between p-6 overflow-y-auto text-slate-800 shadow-sm ${
